...
public class AvaliacaoController {
    ...
    public ResponseEntity novaAvaliacao(@RequestBody AvaliacaoModel avaliacao,
        ...
        avaliacao.setMotorista(motoristaModel);
        try {
            avaliacaoService.adicionar(avaliacao);
        } catch (NoSuchElementException e) {
            return new ResponseEntity("Não foi possível cadastrar avaliaçao.", HttpStatus.BAD_REQUEST);
        }
        return new ResponseEntity(" Avaliaçao cadastrada!", HttpStatus.CREATED);
    }
